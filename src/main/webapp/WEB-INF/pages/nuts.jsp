  ...
  <body>
    ...
    <div class="">
      ...
      <!-- Page Features -->
         ...
         <select id="productId" style="margin-bottom: 5px" class="form-control">
    <c:forEach var="nuts" items="${datas}">     
    <option value="${nuts.nutsName}5${nuts.nutsPath}">${nuts.nutsName}</option>
   </c:forEach>
